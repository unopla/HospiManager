...
class TelaLogin(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.configure(fg_color="#e3f2fd")  # fundo suave hospitalar
        ...
        self.card = ctk.CTkFrame(
            ...
            border_width=1,
            border_color="#b0c4de",
            width=500,   # aumento de largura
            height=520   # aumento de altura
        )
        ...
        self.input_usuario.pack(pady=(5, 10))
        ...
        self.btn_toggle.pack(pady=(0, 15))
        ...
        # ===== FOOTER =====================================================
        footer = ctk.CTkFrame(self, fg_color="#0d47a1", height=36)
